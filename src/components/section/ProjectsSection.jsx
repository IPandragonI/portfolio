...
const ProjectsSection = () => {
    ...
    return (
        <div className="flex flex-col md:px-0 h-full w-10/12 py-10 md:h-5/6 md:py-0 absolute z-10">
            <h1 className='text-3xl text-center md:text-end'>{t('projectSection_title')}</h1>
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className='flex cursor-hover'>
                                <ArrowRight size={32} color="#E284EB" weight="bold" className='mr-4 project-arrow cursor-hover' />
                                <div className='h-1/2 w-full flex justify-between items-center cursor-hover'>
                                    <h1 className='text-lg md:text-2xl font-bold project-name cursor-hover'>{project.name}</h1>
                                    <p className='text-sm md:text-lg cursor-hover'>{project.description}</p>
                                </div>
                            </div>
                            <hr className='w-full my-2 border-2 cursor-hover' />
                        </div>
                    ))}
                </div>
            </div>
